...
class CSFramework_Option_icon extends CSFramework_Options {
  ...
  public function output() {
    ...
    echo '<a href="#" class="button button-primary cs-icon-add">'. __( 'Add Icon', 'maintenance-mode-free' ) .'</a>';
    echo '<a href="#" class="button cs-warning-primary cs-icon-remove'. $hidden .'">'. __( 'Remove Icon', 'maintenance-mode-free' ) .'</a>';
