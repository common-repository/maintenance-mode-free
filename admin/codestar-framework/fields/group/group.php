...
class CSFramework_Option_group extends CSFramework_Options {
  ...
  public function output() {
    ...
    $acc_title   = ( isset( $this->field['accordion_title'] ) ) ? $this->field['accordion_title'] : __( 'Adding', 'maintenance-mode-free' );
    ...
    echo '<div class="cs-group hidden">';
      ...
      echo '<div class="cs-element cs-text-right"><a href="#" class="button cs-warning-primary cs-remove-group">'. __( 'Remove', 'maintenance-mode-free' ) .'</a></div>';
      echo '</div>';
