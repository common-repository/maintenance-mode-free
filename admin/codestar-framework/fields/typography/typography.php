...
class CSFramework_Option_typography extends CSFramework_Options {
  ...
  public function output() {
    ...
    if( is_object( $google_json ) ) {
      ...
      echo '<optgroup label="'. __( 'Web Safe Fonts', 'maintenance-mode-free' ) .'">';
      ...
      echo '<optgroup label="'. __( 'Google Fonts', 'maintenance-mode-free' ) .'">';
      ...
      echo __( 'Error! Can not load json file.', 'maintenance-mode-free' );
