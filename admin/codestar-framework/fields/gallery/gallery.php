...
class CSFramework_Option_Gallery extends CSFramework_Options {
  ...
  public function output(){
    ...
    $add    = ( ! empty( $this->field['add_title'] ) ) ? $this->field['add_title'] : __( 'Add Gallery', 'maintenance-mode-free' );
    $edit   = ( ! empty( $this->field['edit_title'] ) ) ? $this->field['edit_title'] : __( 'Edit Gallery', 'maintenance-mode-free' );
    $clear  = ( ! empty( $this->field['clear_title'] ) ) ? $this->field['clear_title'] : __( 'Clear', 'maintenance-mode-free' );
