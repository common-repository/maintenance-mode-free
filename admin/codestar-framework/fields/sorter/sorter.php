...
class CSFramework_Option_Sorter extends CSFramework_Options {
  ...
  public function output(){
    ...
    $enabled_title  = ( isset( $this->field['enabled_title'] ) ) ? $this->field['enabled_title'] : __( 'Enabled Modules', 'maintenance-mode-free' );
    $disabled_title = ( isset( $this->field['disabled_title'] ) ) ? $this->field['disabled_title'] : __( 'Disabled Modules', 'maintenance-mode-free' );
